var api_shop={
            ...
            "sub_ability": [
                {
                    "sub_id": "1",
                    "sub_name": "模板短信",
                    "description": "物流通知：支持当物流状态发生变化时，系统自动下发发货通知、收货提醒等。验证码发送：支持客户提交验证码模板，审核通过后直接调用模板短信接口触发验证码发送。",
                    "ability_icon":"data/images/api/api1-1.png",

                    "scene": "物流通知：当物流状态发生变化时，系统自动下发发货通知、收货提醒等。会议通知：在线发起会议创建、更改时间等操作，以短信形式发送给参会人。验证码发送：客户提交验证码模板，审核通过后直接调用模板短信接口触发验证码发送。动账提醒：客户提交动账提醒模板，审核通过后直接调用模板短信接口触发动账提醒短信发送。",
                    "api_list": [
                        {
                            "sub_api_name": "发送普通短信",
                    ...
                    "sub_api_type": "通信服务能力",
                    "detail_url": "http://112.35.23.8:1080/open_devportal/index.jsp ",
                 "cases":[
    ...
    ,
                ...
                },
                {
                    ...
                    "scene": "企业宣传：支持用户可以将来/去电身份提示设置为企业信息，每次通话时，对呼叫方进行一次点对点的企业宣传。身份告知：支持用户将来/去电身份提示设置为企业信息或个人信息，每次通话时，将身份告知呼叫方，提升电话接通率。",
                    "api_list": [
                        {
                 ...
                 "cases":[
                         ...
                         {
                  "image_url" :"data/images/api/youzhnegwuliu.png"
    ,
                              "desc":""

                        },
                        {
                            "image_url": "data/images/api/sihaitong.png",
                            "desc": ""
                        }
                     ]
                },
                {
                    ...
                    "scene": "政府公益宣传：支持政府、公安等对管辖范围内民众发送公益宣传类视频短信，如“512防灾减灾日”下发防灾减灾宣传片。企业内部宣传：支持企业宣传片、一分钟党课、工作技能指导等内容，通过视频短信下发给企业员工，进行企业学习宣传。",
                    "api_list": [
                        {
    ...
    ,
                ...
                },
                {
                    ...
                    "sub_api_owner": "中国移动通信开放平台",
                    "sub_api_type": "音视频",
                    "detail_url": "http://112.13.167.90/portal_test/productIntroductionAction.action?eaId=4",
                 "cases":[

                         {
                  "image_url" :"data/images/api/yingshi.png"
    ,
                              "desc":""
                ...
                },
                {
                    ...
                    "sub_api_owner": "中国移动通信开放平台",
                    "sub_api_type": "音视频",
                    "detail_url": "http://112.13.167.90/portal_test/productIntroductionAction.action?eaId=5",
                 "cases":[

                         {
                  "image_url" :"data/images/api/chubao.png",
                              "desc":""

                        },
                        {
                            "image_url": "data/images/api/yunzhixun.png",
                            "desc": ""
                        },
                        {
                            "image_url": "data/images/api/yidianling.png",
                            "desc": ""
                        }
                     ]
                },
                {
                    ...
                    "scene": "号码保护：通过为主被叫真实号码分配中间号，用于主被叫号码之间临时通信使用，起到主被叫号码保护作用。广泛应用于网约车、快递物流、中介、O2O等临时通信场景。",
                    "api_list": [
                        {
                            "sub_api_name": "绑定接口",
                ...
                },
                {
                 ...
                 "cases":[
                         ...
                         {
                  "image_url" :"data/images/api/yidongcanyun.png"
    ,
                              "desc":""

                        },
                        {
                            "image_url": "data/images/api/xunmeng.png",
                            "desc": ""
                        }
                     ]
                },
                {
                    ...
                    "scene": "一对一教学场景：支持网络教学，尤其是一对一教学模式老师和学生沟通。视频直播：支持随时随地满足视频直播需求，保证视频清晰不卡顿。",
                    "api_list": [
                        {
                    ...
                    "sub_api_owner": "中国移动行业应用使能平台",
                    "sub_api_type": "通信服务能力",
                    "detail_url": "uc.ipower.10086.cn/iaep/open_devportal/productIntroductionAction.action?eaId=30",
                 "cases":[
    ...
    ,
                        ...
                        {
                            "image_url": "data/images/api/huawei.png",
                            "desc": ""
                        }
                     ]
                },
                {
                    "sub_id": "9",
                    "sub_name": "用户级QoS加速",
                    "description": "对指定终端用户访问特定IP时进行保障加速，提升用户游戏、观看直播等在线活动的体验。",
                 ...
                 "cases":[
                         ...
                         {
                  "image_url" :"data/images/api/tengxunyouxi.png"
    ,
                              "desc":""
            ...
            "sub_ability": [
                {
                    "sub_id": "1",
                    "sub_name": "统一认证",
                    "description": "是中国移动面向移动互联网应用提供的登录及认证服务。",
                    ...
                    "sub_api_owner": "中国移动互联网能力平台",
                    "sub_api_type": "统一认证能力",
                    "detail_url": "dev.10086.cn/cmpassport/",
                 "cases":[
    ...
    ,
                ...
                },
                {
                    ...
                    "scene": "注册认证：支持用户通过手机号码进行账户注册时，使用自己手机号码拨打平台分配号码，即可完成注册流程。支付验证：支持用户在支付时，拨打验证身份真实性，确保资金安全。",
                    "api_list": [
                        {
                 ...
                 "cases":[
                         ...
                         {
                  "image_url" :"data/images/api/zhifubao.png"
    ,
                              "desc":""

                        },
                        {
                            "image_url": "data/images/api/mengxiangxiaozhen.png",
                            "desc": ""
                        }
                     ]
                }
            ...
            "sub_ability": [
                {
                    "sub_id": "1",
                    "sub_name": "设备管理",
                    "description": "设备管理提供了对设备的增加，删除，修改，查询的相关能力。同时也提供修改设备基本信息的能力。",
                    "ability_icon":"data/images/api/api3-1.png",
                    "scene": "设备管理：支持用户向平台申请设备注册，获取设备的ID和注册码,设备在平台完成南向接入，设备将与用户账号建立从属关系。",
                    "api_list": [
                        {
                            "sub_api_name": "设备注册",
                            "sub_api_desc": "此接口根据产品设置的不同，可以生成新设备及key或获取原有设备及key。"
                        },
                        {
                        ...
                        {
                            "sub_api_name": "精确查询单个设备",
                            "sub_api_desc": "GET方法通过apikey获取单个设备信息。"
                        },
                        {
                            "sub_api_name": "模糊查询设备",
                        ...
                        },
                        {
                            ...
                            "sub_api_desc": "过GET方法，设备id查询设备最新数据。"
                        },
                        {
                            "sub_api_name": "删除设备",
                    ...
                    "sub_api_type": "物联网",
                    "detail_url": "https://open.iot.10086.cn/doc/art262.html#68",
                 "cases":[
                         {
                         "image_url" :"data/images/api/zhiqiankeji.png",
                          "desc":""
                        },
                        {
                ...
                },
                {
                    "sub_id": "2",
                    "sub_name": "数据管理",
                    "description": "数据管理提供数据模型的增删改查接口，适用于数据流和数据点。便于用户快捷对设备数据分析统计。",
                    "ability_icon":"data/images/api/api3-2.png",
                    "scene": "数据管理：支持查询设备下传感器基本信息；支持设备进行订阅，订阅设备后，设备数据更新至平台，平台将会推送给用户,用户可以实时监控设备状态。",
                    "api_list": [
                        {
                            "sub_api_name": "新增数据流",
                        ...
                        {
                            "sub_api_name": "查询数据点",
                            "sub_api_desc": "1. 若不携带任何参数，平台返回本设备所存在的所有数据流中的最新数据； 2. 若不携带数据流id参数，携带limit参数时，会返回该设备每个数据流最多limit条数据。 3. 若要查看某一条数据流数据，需在上述URL中增加参数datastream_id； 4. 要查看某一条数据流在某个时间范围内的数据，可以在增加start和end参数。"
                        }
                    ],
                    "sub_api_owner": "中国移动OneNET平台",
                    "sub_api_type": "物联网",
                    "detail_url": "https://open.iot.10086.cn/doc/art261.html#68",
                 "cases":[
                         {
                        ...
                        {
                            "image_url": "data/images/api/meiguiwulian.png",
                            "desc": ""
                        }
                     ]
                },
                {
                    "sub_id": "3",
                    "sub_name": "规则引擎",
                    "description": "通过规则引擎，用户可对事件自定义触发规则，实现事件的即时发现、高效推送、准确到达。",
                    "ability_icon":"data/images/api/api3-3.png",
                    "scene": "异常触发：支持当设备传感器获取数据时，用户可设置规则引擎对数据异常进行相关操作。",
                    "api_list": [
                        {
                            "sub_api_name": "新增触发器",
                    ...
                    "sub_api_owner": "中国移动OneNET平台",
                    "sub_api_type": "",
                    "detail_url": "https://open.iot.10086.cn/doc/art259.html#68",
                 "cases":[

                         {
                  "image_url" :"data/images/api/link.png"
    ,
                              "desc":""

                        },
                        {
                            "image_url": "data/images/api/saifengkeji.png",
                            "desc": ""
                        },
                        {
                            "image_url": "data/images/api/qihangxinxikeji.png",
                            "desc": ""
                        }
                     ]
                },
                {
                    "sub_id": "4",
                    "sub_name": "命令下发管理",
                    "description": "命令是指应用发送命令数据给OneNET、再由OneNET转发给终端设备、终端设备收到命令后可以向OneNET反馈响应的一种工作机制。命令下发后，应用可以通过API查询命令状态和提取命令的响应数据。",
                    "ability_icon":"data/images/api/api3-4.png",
                    "scene": "命令下发：支持给设备发送命令消息，实现对传感器的实时控制。",
                    "api_list": [
                        {
                            "sub_api_name": "发送命令",
                    ...
                    "sub_api_owner": "中国移动OneNET平台",
                    "sub_api_type": "",
                    "detail_url": "https://open.iot.10086.cn/doc/art257.html#68",
                 "cases":[

                         {
                  "image_url" :"data/images/api/yuanquankeji.png"
,
                              "desc":""
                        ...
                        {
                            "image_url": "data/images/api/comm.png",
                            "desc": ""
                        }   ,
                        {
                            "image_url": "data/images/api/xiguwulian.png",
                            "desc": ""
                        }
                     ]
                },
                {
                    ...
                    "ability_icon":"",
                    "scene": "通信数据管理：支持获取客户通信数据，便于分析客户使用行为，同时具备故障预警、故障定位等功能。物联卡管理：支持获取物联卡状态各类信息，便于改善客户运营流程，降低运营成本。",
                    "api_list": [
                        {
                            "sub_api_name": "用户信息管理",
                ...
                },
                {
                    "sub_id": "7",
                    "sub_name": "NB-IoT接入能力",
                    "description": "通过POST方法在OneNET平台生成设备信息。",
                    "ability_icon":"",
            ...
            "sub_ability": [
                {
                    ...
                    "scene": "一键上网：一键连接家庭或公共网络，无需其它操作，简单快捷。设备接入：将智能设备接入家庭控制网关，打造智慧家居。",
                    "api_list": [
                        {
                            "sub_api_name": "设备发送广播",
                 ...
                 "cases":[
                         ...
                         {
                  "image_url" :"data/images/api/xiaomi_andlink.png"
    ,
                              "desc":""
                        ...
                        {
                            "image_url": "data/images/api/haier.png",
                            "desc": ""
                        },
                        {
                            "image_url": "data/images/api/wulian.png",
                            "desc": ""
                        },
                        {
                            "image_url": "data/images/api/rokid.png",
                            "desc": ""
                        },
                        {
                            "image_url": "data/images/api/rongshida.png",
                            "desc": ""
                        }
                    ]
                },
                {
                    ...
                    "scene": "智能设备控制：使用手机APP或微信H5页面控制家中的智能设备。固件升级：通过绑定智能家居的用户APP完成对该设备的行固件升级。定位监视：儿童/老人定位器接入云平台后，家人可使用客户端查看位置信息。故障告警：为指定设备故障或状态设置告警通知，系统自动下发告警提示信息。",
                    "api_list": [
                        {
                 ...
                 "cases":[
                         ...
                         {
                  "image_url" :"data/images/api/M.png"
    ,
                              "desc":""

                        },
                        {
                            "image_url": "data/images/api/fushuiyuan.png",
                            "desc": ""
                        },
                        {
                            "image_url": "data/images/api/modun.png",
                            "desc": ""
                        },
                        {
                            "image_url": "data/images/api/diqee.png",
                            "desc": ""
                        },
                        {
                            "image_url": "data/images/api/oulin.png",
                            "desc": ""
                        }
                     ]
                }
            ...
            "sub_ability": [
                {
                    "sub_id": "1",
                    "sub_name": "和包贷",
                    "description": "1、为使用和包信用支付的合作机构提供订单申请、页面通知、后台通知、查询、退款通知等服务，具有通知方式及时有效等特点。2、为使用和包信用评级能力的合作机构提供对对用户进行信用评级的服务。3、为与和包合作的金融服务公司提供款资质审核通知、业务受理／撤销通知、主动扣款、主动扣款结果查询、确认文件、分期扣款结果文件等服务。",
                 ...
                 "cases":[
                         ...
                         {
                  "image_url" :"data/images/api/weixinjinke.png"
    ,
                              "desc":""

                        },
                        {
                            "image_url": "data/images/api/xiaofeijinrong.png",
                            "desc": ""
                        }
                     ]
                },
                {
                    ...
                    "scene": "支付：和包支付支持线上支付功能。和包支付支持使用移动公司各类营销资源，解决用户引流及营销痛点问题。线下支付：和包支付支持线下支付功能。和包支付支持使用移动公司各类营销资源，解决用户引流及营销痛点问题。",
                    "api_list": [
                        {
                            "sub_api_name": "调起支付接口",
    ...
    ,
                        ...
                        {
                            "image_url": "data/images/api/meihaoanhui.png",
                            "desc": ""
                        },
                        {
                            "image_url": "data/images/api/shankefeng.png",
                            "desc": ""
                        },
                        {
                ...
                },
                {
                 ...
                 "cases":[
                         ...
                         {
                  "image_url" :"data/images/api/bubugao.png"
    ,
                              "desc":""
            ...
            "sub_ability": [
                {
                    "sub_id": "1",
                    "sub_name": "咪咕游戏分享",
                    "description": "通过在游戏界面设置入口按钮，点击进入游戏分享界面，在游戏中实现截屏分享功能。",
                    "ability_icon":"data/images/api/api6-1.png",
                    "scene": "游戏内截屏分享的社交需求（例如 会议通知的应用场景如下：会议通知： 支持将文字以语音播报的形式传达给用户，通知方式及时有效等；）",
                    "api_list": [
                        {
                            "sub_api_name": "更多游戏接口",
                            "sub_api_desc": "按照咪咕游戏合作方游戏接入规范，游戏主菜单需要添加《更多游戏》入口。点击此按钮，需调用接口实现更多游戏逻辑。"
                        },
                        {
                            "sub_api_name": "游戏分享接口",
                            "sub_api_desc": "在游戏中实现截屏分享功能，需要在游戏界面设置入口按钮，点击即进入游戏分享界面。"
                        }
                    ],
                    "sub_api_owner": "中国移动咪咕游戏开放平台",
                    "sub_api_type": "内容分享",
                    "detail_url": "http://g.10086.cn/open/sdkfaq/index.html#/develop_document",
                 "cases":[
...
,
                ...
                },
                {
                    "sub_id": "2",
                    "sub_name": "咪咕游戏智能手柄接入",
                    "description": "提供通过蓝牙接入游戏智能手柄的能力，利用蓝牙手柄与运行游戏的终端设备连接，使用蓝牙手柄取代游戏中的虚拟按键。",
                    "ability_icon":"data/images/api/api6-2.png",
                    "scene": "蓝牙手柄：对于具有虚拟按键使用需求的游戏，使用蓝牙手柄取代游戏中的虚拟按键，增强游戏的操作友好性。",
                    "api_list": [
                         {
                            "sub_api_name": "更多游戏接口",
                            "sub_api_desc": "按照咪咕游戏合作方游戏接入规范，游戏主菜单需要添加《更多游戏》入口。点击此按钮，需调用接口实现更多游戏逻辑。"
    ...
    ,
                ...
                },
                {
                    ...
                    "scene": "点播：资讯网站、游戏平台、音乐社区、UGC 视频网站、视频门户、媒体门户、橱窗展示、产品详情、视频晒单评论、教育培训、企业培训、校园培训等视频点播需求。直播：在线直播、VR直播。",
                    "api_list": [
                        {
                ...
                },
                {
                    ...
                    "scene": "SSP平台的统一接入：广告请求展示、数据上报等服务。DSP平台的统一接入：包括广告主信息同步、订单同步、审核确认等服务",
                    "api_list": [
                        {
                 ...
                 "cases":[
                         ...
                         {
                  "image_url" :"data/images/api/junbowangluo.png"
,
                              "desc":""
                ...
                },
                {
                    ...
                    "scene": "新闻消息推送：新闻类应用在重大新闻事件发生时，可使用有推推送将最新新闻及时推送给用户。APP消息推送：app有版本更新、营销优惠活动时，可使用有推推送及时推送给用户。",
                    "api_list": [
                        {
            ...
            "sub_ability": [
                {
                    ...
                    "scene": "业务订购：4G飞享合约，4G基础套餐，流量加油包，流量直充包，国际漫游包，定向流浪包等业务的订购。",
                    "api_list": [
                        {
    ...
    ,
                ...
                },
                {
                    ...
                    "scene": "在线支付：支持第三方，话费及积分支付方式。在线计费：基于手机账户的计费支付功能，支持APP、网页等多种计费需求，支持单次、包月等灵活的计费策略",
                    "api_list": [
                        {
                            "sub_api_name": "支付请求接口",
            ...
            "sub_ability": [
                {
                    ...
                    "scene": "多资源混合管理：开发者可以通过API接口将移动云资源嵌入自己的云管理平台，实现多资源混合管理。构建上层服务：可以使用基础资源API来构建各种上层服务，提升自有应用系统的可用性与扩展能力。",
                    "api_list": [
                        {
                            "sub_api_name": "云主机",
    ...
    ,
                ...
                },
                {
                    ...
                    "scene": "机器人：私人助手，可识别用户声音并给出回答。人机交互：智能客服，解决用户问题。在线教育：指导用户发音学习。有声阅读：将文字转化为声音，解放双眼进行阅读。声纹密码：通过声音解锁。",
                    "api_list": [
                        {
                        ...
                        },
                        {
                            ...
                            "sub_api_desc": "声纹注册成功后，在语音云端上会生成一个对应的模型来存储声纹信息，声纹模型的操作即对 模型进行查询和删除。"
                        },
                        {
                 ...
                 "cases":[
                        ...
                        {
                            "image_url": "data/images/api/guotoudianli.png",
                            "desc": ""
                        }
                     ]
                }
            ...
            "sub_ability": [
                {
                    ...
                    "scene": "在线园所：可以在幼儿园各个场所安装摄像头，父母随时查看宝宝在幼儿园中的生活。突破传统的办公方式，提升品牌价值。保险定损：执行人员随身携带终端设备，执行过程呼叫后台查看实时视频，并指导前端操作，支持对整个过程的留存备案。",
                    "api_list": [
                        {
                            "sub_api_name": "实时视频",
                 ...
                 "cases":[
                         ...
                         {
                  "image_url" :"data/images/api/haikangweishi.png"
    ,
                              "desc":""
                ...
                },
                {
                    ...
                    "scene": "跨部门沟通：可应用在政府事业单位间，实行多级调动管理，跨地域联动工作。物流运输：应用在物流运输场景中，整合对讲、定位、调度资源，提升管理效率。",
                    "api_list": [
                        {
                            "sub_api_name": "语音对讲",
                 ...
                 "cases":[
                         ...
                         {
                  "image_url" :"data/images/api/datangdianxin.png",
                              "desc":""
                ...
                },
                {
                 ...
                 "cases":[
                         ...
                         {
                  "image_url" :"data/images/api/jianchayuan.png"
,
                              "desc":""
                ...
                },
                {
                 ...
                 "cases":[
                         ...
                         {
                  "image_url" :"data/images/api/gongshangyinhang.png"
    ,
                              "desc":""
        ...
        },
        {
            ...
            "sub_ability": [
           {
                ...
                },
                {
                    ...
                    "scene": "统一地图接口：在PC端或者移动端上，开发者需要在应用或者浏览器内显示地图、查询公交、POI搜索等功能时可调用此能力。应用案例：有线宽带覆盖及开户校园精准营销；外勤管理系统。社区矫正系统；电动车定位管理系统；高速路网智能监控系统；119消防火警救援系统；政企客户园区地图；在线公司客服系统",
                    "api_list": [
                        {
