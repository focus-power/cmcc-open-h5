...
!function($){
    $.fn.scrollBanner = function(obj){
        ...
        $(".scrollBanner-icons").css({
            "width": 25*obj.images.length+ 60 +"px",
            "height": "10px",
            "position":"absolute",
            "bottom":"40px",
            "z-index": "100",
        ...
        setInterval(function(){
            ...
            /*$(".scrollBanner-bannerInner img").animate({
                width: "120%",
                height: "500px"},
                "slow", function() {*/
            ...
            $(".scrollBanner-icon").css({"background-color": obj.iconColor, "width": "10px"});
            $(".scrollBanner-icon:eq("+count+")").css({"background-color": obj.iconHoverColor, "width": "50px", "transition": "all .5s ease"});

            if(count>=obj.images.length)
                $(".scrollBanner-icon:eq("+0+")").css({"background-color": obj.iconHoverColor, "width": "50px", "transition": "all .5s ease"});
        ...
        $(".scrollBanner-icon").click(function(){
            $(".scrollBanner-icon").css({"background-color": obj.iconColor, "width": "10px"});
            // ↓ 由span触发mouseover事件，则this指向这个span。
            // ↓ 但是，这this是JS对象，必须使用$封装成JQuery对象。
            $(this).css({"background-color": obj.iconHoverColor, "width": "50px"});
